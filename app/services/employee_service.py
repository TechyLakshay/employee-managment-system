...
# from app.logger import logger, generate_correlation_id
...
#     try:
#         logger.debug(
#             f"Creating employee {employee.employee_id} | user_id={user_id} | system_id={SYSTEM_ID} | correlation_id={correlation_id}"
#         )
...
#         logger.error(
#             f"Create failed | employee_id={employee.employee_id} | correlation_id={correlation_id} | error={error}"
#         )
...
#         connection.close()
#         logger.debug(
#             f"DB closed for create_employee | correlation_id={correlation_id}"
#         )
...
#     try:
#         logger.debug(
#             f"Fetching employees | user_id={user_id} | system_id={SYSTEM_ID} | correlation_id={correlation_id}"
#         )
...
#         logger.info(
#             f"Fetched {len(employees)} employees | correlation_id={correlation_id}"
#         )
...
#     except Exception as error:
#         logger.error(
#             f"Fetch failed | correlation_id={correlation_id} | error={error}"
#         )
#         return {"error": str(error)}
...
#         connection.close()
#         logger.debug(
#             f"DB closed for get_all_employees | correlation_id={correlation_id}"
#         )
...
#         logger.info(
#             f"Employee updated | employee_id={employee_id} | correlation_id={correlation_id}"
#         )
...
#         connection.close()
#         logger.debug(
#             f"DB closed for update_employee | correlation_id={correlation_id}"
#         )
...
#         logger.info(
#             f"Employee deleted | employee_id={employee_id} | correlation_id={correlation_id}"
#         )
...
#         connection.close()
#         logger.debug(
#             f"DB closed for delete_employee | correlation_id={correlation_id}"
#         )

from app.database import get_db_connection, generate_correlation_id
from app.logger import logger

SYSTEM_ID = "employee_api"


def create_employee(employee, correlation_id, user_id="system"):
    connection = None
    cursor = None
...
def get_all_employees(correlation_id, user_id="system"):
    connection = None
    cursor = None
...
def update_employee(employee_id, employee, correlation_id, user_id="system"):
    connection = None
    cursor = None
    ...
    try:
        ...
        logger.error(
            f"Update failed | employee_id={employee_id} | "
            f"correlation_id={correlation_id} | error={error}"
        )
        return {"error": str(error)}
...
def delete_employee(employee_id, correlation_id, user_id="system"):
    connection = None
    cursor = None
    ...
    try:
        ...
        logger.error(
            f"Delete failed | employee_id={employee_id} | "
            f"correlation_id={correlation_id} | error={error}"
        )
        return {"error": str(error)}
